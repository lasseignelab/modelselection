...
saveRDS(cl_ndtis_indgene, "../data/rse_subsets/63856/ind_gene/cl_ndtis_indgene.rds")
...
saveRDS(pdx_ndtis_indgene, "../data/rse_subsets/63856/ind_gene/pdx_ndtis_indgene.rds")
...
hist(cl_ndtis_indgene$rho, breaks = 50, main = "Histogram of Correlation Between Brain Cell Lines and Brain Non-Disease Tissue", xlab = "Spearman's Rho")
...
hist(pdx_ndtis_indgene$rho, breaks = 50, main = "Histogram of Correlation Between Brain PDXs and Brain Non-Disease Tissue", xlab = "Spearman's Rho")
```
...
for(i in c("cl_tumtis", "cl_ndtis", "pdx_tumtis", "pdx_ndtis")){
  ...
  for(i in c("sig", "insig")){
    ...
    indgene_cor_pathway_res_sub_dfs_posneg[[comparison]][[i]][["term_name"]] <- str_trunc(indgene_cor_pathway_res_sub_dfs_posneg[[comparison]][[i]][["term_name"]], 30)
