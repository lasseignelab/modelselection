...
```{r source load}
source("/Users/avery/Desktop/work/R Projects/modelselection/scripts/functions/rse_to_subset.R") # change to where you have this function script saved
```
...
purity_genes <- readRDS("~/Desktop/work/R Projects/modelselection/data/purity_genes.rds") # replace filepath
```
...
for(i in project){
  project_sub <- i
  rse_sub <- readRDS(paste("/Users/avery/Desktop/work/R Projects/modelselection/data/recount3/rse", "/", project_sub, "_rse.rds", sep = ""))
  ...
  for(i in subset_num){
    ...
    for(i in var_source){
      ...
      rse_to_subset(rse_sub, project_sub, subset_sub, var_sub, TRUE, TRUE, TRUE, "/Users/avery/Desktop/work/R Projects/modelselection/data/rse_subsets/") # with purity
      rse_to_subset(rse_sub, project_sub, subset_sub, var_sub, FALSE, TRUE, TRUE, "/Users/avery/Desktop/work/R Projects/modelselection/data/rse_subsets/") # without
    }
  }
}
```
