...
foreach(i = 1:length(projects), .packages = "recount3") %dopar% (getGTEXrse(project = projects[i], savefilepath = "../data/recount3/"))
...
foreach(i = 1:length(projects), .packages = "recount3") %dopar% (getTCGArse(project = projects[i], savefilepath = "../data/recount3/"))
