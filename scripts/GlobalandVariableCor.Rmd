...
## by just origin type
colorset <- rainbow(4)
#png("~/Desktop/work/R Projects/modelselection/plots/pca_origintype.png")
Scatter_Density(object = all_pca, batch = brain_fact_origin, color.set = colorset, batch.legend.title = "Origin Type")
#dev.off() # NOTE: for some reason with png() the image quality is always bad, even when I scale up dimensions. Better off generating plot in R script then > save image
...
```{r} 
cor_dismatch_res_all <- readRDS("/Users/avery/Desktop/work/R Projects/modelselection/data/rse_subsets/63856/corres/cor_dismatch_res_all.rds") # local
...
## hm time
png("~/Desktop/work/R Projects/modelselection/plots/hm_brainsubs.png", width = 700, height = 900)
...
tum_violin_alt + 
  stat_pvalue_manual(stat.test, tip.length = 0) +
  labs(subtitle = get_test_label(stat.test, detailed = TRUE))
ggsave(filename = "~/Desktop/work/R Projects/aw_tumor_cellline_pdx/plots/tags_violin/fullgenesvio_brainclvspdx_tum.png", 
          width = 5, height = 6)
...
con_violin_alt + 
  stat_pvalue_manual(stat.test, tip.length = 0) +
  labs(subtitle = get_test_label(stat.test, detailed = TRUE))
ggsave(filename = "~/Desktop/work/R Projects/aw_tumor_cellline_pdx/plots/tags_violin/fullgenesvio_brainclvspdx_con.png", 
          width = 5, height = 6)
```
...
cor_dismatch_res_all <- readRDS("~/Desktop/work/R Projects/modelselection/data/rse_subsets/63856/corres/cor_dismatch_res_all.rds")
...
ggsave(filename = "~/Desktop/work/R Projects/aw_tumor_cellline_pdx/plots/vio_braincltoeachtum.png", 
          width = 13, height = 7)
...
ggsave(filename = "~/Desktop/work/R Projects/aw_tumor_cellline_pdx/plots/vio_braincltoeachcon.png", 
          width = 13, height = 7)
```
