...
# now just cell lines
tissuecormatch(rootfilepath = "/Users/avery/Desktop/work/R Projects/modelselection/data/rse_subsets/", row_sources = c("bone_c", "ccle", "hpa_c"), col_sources = c("tcga", "gtex", "hpa_t", "bone_n", "bone_t"), sub = 63856, app_by = "disease", save = TRUE, savefilepath = "/Users/avery/Desktop/work/R Projects/modelselection/data/rse_subsets/")
...
cor_temp <- readRDS("~/Desktop/work/R Projects/modelselection/data/rse_subsets/63856/corres/cor_dismatch_res_allCL.rds")[["dfo_summary"]]
percent_map_to_origin <- c(percent_map_to_origin, cor_temp$same_as_origin/(cor_temp$different + cor_temp$same_as_origin))
      id <- c(id, "all")
...
png(file="/Users/avery/Desktop/work/R Projects/modelselection/plots/genesetsize_hm_indcancers.png", width = 800, height = 600, pointsize = 14)
