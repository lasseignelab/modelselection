...
read in TPM objects
```{r}
gtex_tpm <- readRDS("~/code_review/modelselection/data/recount3/tpm/gtex_tpm.rds")
tcga_tpm <- readRDS("~/code_review/modelselection/data/recount3/tpm/tcga_tpm.rds")
bone_n_tpm <- readRDS("~/code_review/modelselection/data/recount3/tpm/bone_n_tpm.rds")
bone_t_tpm <- readRDS("~/code_review/modelselection/data/recount3/tpm/bone_t_tpm.rds")
hpa_t_tpm <- readRDS("~/code_review/modelselection/data/recount3/tpm/hpa_t_tpm.rds")

ccle_tpm <- readRDS("~/code_review/modelselection/data/recount3/tpm/ccle_tpm.rds")
pdx_tpm <- readRDS("~/code_review/modelselection/data/recount3/tpm/pdx_tpm.rds")
hpa_c_tpm <- readRDS("~/code_review/modelselection/data/recount3/tpm/hpa_c_tpm.rds")
bone_c_tpm <- readRDS("~/code_review/modelselection/data/recount3/tpm/bone_c_tpm.rds")
